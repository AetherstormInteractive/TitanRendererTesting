...
std::vector<const char*> VulkanRenderer::getRequiredExtensions() 
{
	...
	SDL_Vulkan_GetInstanceExtensions(window, &sdl2ExtensionCount, NULL);
	const char** sdl2Extensions = (const char**)malloc(sizeof(char*) * sdl2ExtensionCount);
	SDL_Vulkan_GetInstanceExtensions(window, &sdl2ExtensionCount, sdl2Extensions);
...
{
	//destroy vk device, surface, and instance
